...
<html lang="zh-cn">
  ...
  <body class="body">
      ...
      <h2 class="title container-fluid">
        ...
        <span class="top-title"><a href="newMsg">消息</a></span>
      </h2>
      <!-- 主要内容 -->
      <div class="container-fluid">
        <div class="cards cards-condensed ">
        	<c:forEach items="${sysmsg}" var="sysmsg">
			              <div class="card container-fluid">
			                <!--<a> 跳转到不同的订单详情页 -->
			                <a href="orderManagement_OrderDetails_inTransit.jsp">
			                <img src="images/bike.png" height="20%" width="20%">
			                <span class="time">${sysmsg.times}</span>
			                <h3 class="head3">${status[sysmsg.status] }</h3>
			                <div class="">${sysmsg.content }
